...
First, calculate the distance between each pair of Pokemon present on the map, as well as Ash's home to each Pokemon, and store this in an array. Distances can be calculated using this formula: $$\abs{x_1 − x_2} + |y_1 − y_2|$$, where $$(x_1, y_1)$$ and $$(x_2, y_2)$$ are two coordinate locations.
